    ...
    public class ResResult: IResResult
    {
        ...
        public static IResResult Create(QueryTransactionResultsResponse rt)
        {
            ...
            if (result.Status.IsSuccess())
            {
                ...
                result.Response.Add(new Response() { ClientId = rt.Trans.CertSeqNo, ObssId = rt.Trans.HostSeqNo, EDIId = Instruction.NewInsSid("02") });                           
            return result;
        }
        ...
        public static IResResult Create(ResponseMsg msg)
        {
            ...
            foreach (var item in msg.DetailResponses)
            {
                ...
                result.Response.Add(new Response() { Status = status, ClientId = item.Insid, ObssId = item.Obssid, EDIId = Instruction.NewInsSid("01") });
            }
            return result;
        }
